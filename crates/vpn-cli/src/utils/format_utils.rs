...
pub fn format_connection_string(host: &str, port: u16, protocol: &str) -> String {
    match protocol.to_lowercase().as_str() {
        "vless" | "vmess" | "trojan" => format!("{}://{}", protocol.to_lowercase(), format_addr(host, port)),
...
pub fn format_error_context(error: &str, context: Option<&str>, suggestion: Option<&str>) -> String {
