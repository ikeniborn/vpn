...
pub fn common_labels(vpn: &VpnServer) -> BTreeMap<String, String> {
    ...
    labels.insert("vpn.io/protocol".to_string(), format!("{:?}", vpn.spec.protocol).to_lowercase());
...
pub fn common_annotations(vpn: &VpnServer) -> BTreeMap<String, String> {
    ...
    annotations.insert("vpn.io/version".to_string(), env!("CARGO_PKG_VERSION").to_string());
...
pub fn owner_reference(vpn: &VpnServer) -> Vec<k8s_openapi::apimachinery::pkg::apis::meta::v1::OwnerReference> {
