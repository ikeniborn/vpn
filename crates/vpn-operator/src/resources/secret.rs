...
pub fn create_vpn_secret(vpn: &VpnServer) -> Result<Secret> {
    ...
    match &vpn.spec.protocol {
        ...
        VpnProtocol::OpenVPN => {
            ...
            data.insert(
                "ca_cert".to_string(),
                ByteString(b"CA_CERT_PLACEHOLDER".to_vec()),
            );
            data.insert(
                "server_cert".to_string(),
                ByteString(b"SERVER_CERT_PLACEHOLDER".to_vec()),
            );
            data.insert(
                "server_key".to_string(),
                ByteString(b"SERVER_KEY_PLACEHOLDER".to_vec()),
            );
            data.insert(
                "dh_params".to_string(),
                ByteString(b"DH_PARAMS_PLACEHOLDER".to_vec()),
            );
        }
    }
    ...
    data.insert(
        ...
        ByteString(admin_password.into_bytes()),
    );
