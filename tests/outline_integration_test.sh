...
echo "  - Management URL: https://<host>:<management_port>/<api_secret>/"
echo "  - NOT show SNI or VLESS-specific parameters"
echo ""
echo "The Management URL format is important:"
echo "  - It includes the API secret in the path for secure access"
echo "  - Example: https://192.168.1.100:9388/aBcDeF123456.../"