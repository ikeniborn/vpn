...
from vpn.cli.exit_codes import (
    ExitCode, ExitResult, ExitCodeManager, exit_manager,
    handle_cli_errors, success, error, user_not_found, server_not_found,
    config_error, docker_error, validation_error, operation_cancelled,
    operation_timeout, validate_exit_codes, get_exit_code_documentation
)
...
class TestExitCodeIntegration:
    ...
    def test_global_exit_manager(self):
        ...
        from vpn.cli.exit_codes import exit_manager
