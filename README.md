...
This project provides a simple and effective way to set up a V2Ray VPN server using the VLESS protocol with Docker. It supports both basic VLESS and VLESS+Reality protocols for enhanced security. The project consists of two main scripts:
...
- **Flexible Protocol Options**: Supports both:
  - Basic VLESS protocol over TCP
  - VLESS+Reality protocol for enhanced security and anti-detection
...
- Protocol selection (VLESS basic or VLESS+Reality)
- UUID for the first user (a random UUID is generated by default)
- Name for the first user (defaults to "user1")
- SNI domain (for Reality protocol, defaults to www.microsoft.com)
...
3. **Manual Configuration**
   ...
   **For VLESS+Reality configuration, additional settings:**
     - Security: Reality
     - SNI: Your configured SNI domain
     - Fingerprint: chrome
...
- Reality protocol offers enhanced security and better resistance to detection methods