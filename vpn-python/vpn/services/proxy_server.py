...
from vpn.core.exceptions import ProxyError, AuthenticationError
from vpn.core.models import User, ProxyConfig, ProxyType
...
class ProxyAuth:
    ...
    def parse_basic_auth(self, auth_header: str) -> Tuple[Optional[str], Optional[str]]:
