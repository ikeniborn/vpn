...
from vpn.tui.components import (
    # Lazy loading
    LazyScreen, LoadingConfig, create_loading_config,
    
    # Keyboard shortcuts
    ShortcutManager, ShortcutContext, ShortcutHelpScreen,
    ShortcutCustomizationScreen, get_global_shortcut_manager,
    initialize_shortcuts,
    
    # Focus management
    FocusManager, FocusConfig, FocusGroup, FocusRing,
    get_global_focus_manager, initialize_focus_manager,
    
    # Theme system
    ThemeManager, ThemeCustomizationScreen, get_global_theme_manager,
    initialize_theme_manager,
    
    # Reusable widgets
    InfoCard, StatusIndicator, StatusType, Toast,
)
...
class EnhancedVPNManagerApp(App):
    ...
    def _apply_theme(self, theme) -> None:
        ...
        self.current_theme = theme.metadata.name
...
def run_enhanced_tui(config_dir: Optional[Path] = None) -> None:
