...
class LogEntry:
    ...
    def matches_filter(self, search_term: str, level_filter: str | None = None) -> bool:
    ...
    def to_rich_text(self, highlight_term: str | None = None) -> Text:
...
class LogViewer(Widget, ContextMenuMixin):
    ...
    def __init__(self, log_file: Path | None = None, **kwargs):
