...
class ShortcutManager:
    ...
    def get_active_shortcuts(
        ...
        for shortcut in self.shortcuts.values():
            ...
            if shortcut.context == ShortcutContext.GLOBAL:
                ...
                if context == ShortcutContext.SCREEN and shortcut.screen_name == screen_name:
                    active_shortcuts.append(shortcut)
                elif context == ShortcutContext.WIDGET and shortcut.widget_class == widget_class:
                    active_shortcuts.append(shortcut)
                elif context == ShortcutContext.MODAL:
                    active_shortcuts.append(shortcut)
    ...
    def save_shortcuts(self, config_file: Optional[Path] = None) -> None:
...
class ShortcutMixin:
    ...
    def __init__(self, *args, shortcut_manager: Optional[ShortcutManager] = None, **kwargs):
...
def initialize_shortcuts(config_file: Optional[Path] = None) -> ShortcutManager:
