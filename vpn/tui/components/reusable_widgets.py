...
from textual.widgets import (
    Static, Button, Input, Label, Checkbox, RadioSet, RadioButton,
    DataTable, ProgressBar, Select, Tree, ListView, ListItem,
    TabbedContent, TabPane, Header, Footer, Collapsible
)
...
class MetricCard(Container):
    ...
    def update_value(self, value: str, trend: Optional[str] = None, trend_positive: Optional[bool] = None) -> None:
...
class ValidatedInput(Input):
    ...
    def __init__(
        ...
        on_validation: Optional[Callable[[ValidationResult], None]] = None,
        **kwargs
    ):
