...
class TUIProfiler:
    ...
    def _end_metric(self, name: str) -> Optional[PerformanceMetric]:
...
def start_profiling(app: Optional[App] = None, **kwargs) -> None:
    """Start TUI profiling."""
    if app:
...
def generate_performance_report(output_path: Optional[Path] = None) -> str:
