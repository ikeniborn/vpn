...
from textual.widgets import ScrollView, Static, ListView, ListItem
...
from textual.events import MouseScrollUp, MouseScrollDown, Key
...
class VirtualListItem(Widget):
    ...
    def __init__(self, 
                 ...
                 index: int,
                 height: int = 1,
                 renderer: Optional[Callable[[Any, int], RenderableType]] = None,
                 **kwargs):
...
class VirtualList(ScrollView, Generic[T]):
    ...
    def __init__(self,
                 data_source: Optional[VirtualDataSource[T]] = None,
                 item_height: int = 1,
...
class VirtualTable(VirtualList[Dict[str, Any]]):
    ...
    def __init__(self,
                 ...
                 data_source: Optional[VirtualDataSource[Dict[str, Any]]] = None,
                 **kwargs):
        """
