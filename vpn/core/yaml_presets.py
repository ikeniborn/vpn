...
from .yaml_templates import VPNTemplateEngine, TemplateContext, TemplateType, TemplateResult
...
class YamlPresetManager:
    ...
    def get_preset_metadata(self, name: str) -> Optional[PresetMetadata]:
    ...
    def apply_preset(
        self,
        name: str,
        target_vars: Optional[Dict[str, Any]] = None,
        dry_run: bool = False
    ...
    def show_preset_info(self, name: str) -> None:
        ...
        if 'users' in preset_data and preset_data['users']:
        ...
        if 'servers' in preset_data and preset_data['servers']:
    ...
    def _find_preset_path(self, name: str) -> Optional[Path]:
