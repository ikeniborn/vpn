...
def config_error(message: str, file_path: Optional[str] = None) -> None:
...
def docker_error(message: str, container_name: Optional[str] = None) -> None:
...
def get_exit_code_documentation() -> Dict[str, List[Dict[str, Union[int, str]]]]:
