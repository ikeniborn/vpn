...
from vpn.cli.exit_codes import ExitCode, exit_manager, handle_cli_errors
from vpn.core.yaml_config import create_default_templates, yaml_config_manager
from vpn.core.yaml_migration import SourceFormat, TargetFormat, yaml_migration_engine
from vpn.core.yaml_presets import yaml_preset_manager
from vpn.core.yaml_schema import PresetCategory, PresetScope, yaml_schema_validator
from vpn.core.yaml_templates import TemplateContext, TemplateType, vpn_template_engine
...
def manage_templates(
    ...
    template_name: str | None = typer.Option(None, "--name", "-n", help="Template name"),
    template_type: str | None = typer.Option(None, "--type", "-t", help="Template type"),
    output_path: Path | None = typer.Option(None, "--output", "-o", help="Output file path"),
    variables_file: Path | None = typer.Option(None, "--vars", help="Variables file for rendering")
):
...
def manage_presets(
    ...
    preset_name: str | None = typer.Option(None, "--name", "-n", help="Preset name"),
    category: str | None = typer.Option(None, "--category", "-c", help="Preset category"),
    scope: str | None = typer.Option(None, "--scope", "-s", help="Preset scope"),
    description: str | None = typer.Option(None, "--description", "-d", help="Preset description"),
    file_path: Path | None = typer.Option(None, "--file", "-f", help="File path for import/export"),
...
def batch_migrate(
    ...
    report_path: Path | None = typer.Option(None, "--report", help="Generate migration report")
):
