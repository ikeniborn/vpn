...
class EnhancedUserManager(EnhancedBaseService[User]):
    ...
    async def health_check(self) -> ServiceHealth:
        ...
        try:
            ...
            return ServiceHealth(
                ...
                message=f"Service unhealthy: {e!s}",
                metrics={
                    "cache_size": len(self._user_cache),
                    "circuit_breaker_state": self.circuit_breaker.state.value,
                    "failure_count": self.circuit_breaker.failure_count,
    ...
    async def _get_user_impl(self, user_id: str) -> User | None:
    ...
    async def _get_user_by_username_impl(self, username: str) -> User | None:
    ...
    async def _list_users_impl(self, status: UserStatus | None = None) -> list[User]:
    ...
    async def _update_user_impl(self, user_id: str, **kwargs) -> User | None:
    ...
    async def _create_batch_chunk(self, users_data: list[dict[str, Any]]) -> list[User]:
        ...
        try:
            ...
            raise DatabaseError(f"Batch user creation failed: {e!s}")
        finally:
            await session.close()
    ...
    async def _update_batch_chunk(self, updates: dict[str, dict[str, Any]]) -> list[User]:
        ...
        try:
            ...
            raise DatabaseError(f"Batch user update failed: {e!s}")
        finally:
            await session.close()
    ...
    async def _delete_batch_chunk(self, user_ids: list[str]) -> int:
        ...
        try:
            ...
            raise DatabaseError(f"Batch user deletion failed: {e!s}")
        finally:
            await session.close()
    ...
    async def get_users_batch(
        ...
        if missing_ids:
            ...
            try:
                ...
                raise DatabaseError(f"Batch user fetch failed: {e!s}")
            finally:
                await session.close()
    ...
    async def list_users_optimized(
        ...
        try:
            ...
            raise DatabaseError(f"Optimized user listing failed: {e!s}")
        finally:
            await session.close()
    ...
    async def search_users_full_text(
        ...
        try:
            ...
            raise DatabaseError(f"User search failed: {e!s}")
        finally:
            await session.close()
    ...
    async def get_user_statistics_optimized(self) -> dict[str, Any]:
        ...
        try:
            ...
            raise DatabaseError(f"Statistics query failed: {e!s}")
        finally:
            await session.close()
    ...
    async def _bulk_update_status_chunk(self, user_ids: list[str], new_status: str) -> int:
        ...
        try:
            ...
            raise DatabaseError(f"Bulk status update failed: {e!s}")
        finally:
            await session.close()
