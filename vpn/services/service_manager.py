...
class ServiceManager:
    ...
    def get_service(self, service_name: str) -> Optional[EnhancedBaseService]:
        """Get a service by name."""
        return self._services.get(service_name)
    
    def get_user_manager(self) -> Optional[EnhancedUserManager]:
        """Get the user manager service."""
        return self._services.get("UserManager")
    
    def get_docker_manager(self) -> Optional[EnhancedDockerManager]:
        """Get the Docker manager service."""
        return self._services.get("DockerManager")
    
    def get_network_manager(self) -> Optional[EnhancedNetworkManager]:
...
async def get_user_manager() -> Optional[EnhancedUserManager]:
    """Get the enhanced user manager."""
    manager = await get_service_manager()
    return manager.get_user_manager()


async def get_docker_manager() -> Optional[EnhancedDockerManager]:
    """Get the enhanced Docker manager."""
    manager = await get_service_manager()
    return manager.get_docker_manager()


async def get_network_manager() -> Optional[EnhancedNetworkManager]:
